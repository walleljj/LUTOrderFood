...
/**
 * Servlet implementation class UpdateFoodSvl
 */
@WebServlet("/UpdateFoodSvl")
public class UpdateFoodSvl extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateFoodSvl() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ServletFileUpload sfu = new ServletFileUpload(factory);
			...
			int istate = state!=null&&state.equals("on")?1:0;
			Log.logger.info("state="+istate);
			...
			Food f = new Food();
			f.setFoodid(Integer.parseInt(p.get("foodid")));
