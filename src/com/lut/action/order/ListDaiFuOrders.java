...
/**
 * Servlet implementation class ListDaiFuOrders
 */
@WebServlet("/ListDaiFuOrders")
public class ListDaiFuOrders extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ListDaiFuOrders() {
        super();
